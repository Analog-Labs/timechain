...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 657_833_000 picoseconds.
		Weight::from_parts(758_122_000, 0)
	...
	/// Proof: `Tasks::Tasks` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Tasks::TaskCount` (r:49 w:0)
	/// Proof: `Tasks::TaskCount` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Tasks::ExecutedTaskCount` (r:49 w:0)
	/// Proof: `Tasks::ExecutedTaskCount` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 65_444_000 picoseconds.
		Weight::from_parts(67_819_000, 0)
			.saturating_add(Weight::from_parts(0, 4216))
			// Standard Error: 73_687
			.saturating_add(Weight::from_parts(50_795_727, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(28_869_298, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 123_007
			.saturating_add(Weight::from_parts(56_099_632, 0).saturating_mul(b.into()))
