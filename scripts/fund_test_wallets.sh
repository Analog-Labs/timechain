...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile1 pubkey
...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile2 pubkey
...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile3 pubkey
...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile4 pubkey
...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile5 pubkey
...
rosetta-wallet --url=$eth_url --blockchain=$eth_blockchain --network=$eth_network --keyfile=dummy_wallets/eth_keyfile6 pubkey
