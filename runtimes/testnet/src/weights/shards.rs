...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 515_935_000 picoseconds.
		Weight::from_parts(536_082_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(68_799_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `582`
		//  Estimated: `11472`
		// Minimum execution time: 120_595_000 picoseconds.
		Weight::from_parts(128_902_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 125_945_000 picoseconds.
		Weight::from_parts(30_971_692, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 247_199
			.saturating_add(Weight::from_parts(108_823_401, 0).saturating_mul(b.into()))
