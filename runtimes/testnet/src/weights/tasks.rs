...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 654_895_000 picoseconds.
		Weight::from_parts(678_900_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 75_431_000 picoseconds.
		Weight::from_parts(3_003_038, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 90_288
			.saturating_add(Weight::from_parts(62_420_324, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_933_770, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 99_334
			.saturating_add(Weight::from_parts(56_795_600, 0).saturating_mul(b.into()))
