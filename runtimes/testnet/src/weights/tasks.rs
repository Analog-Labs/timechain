...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 647_472_000 picoseconds.
		Weight::from_parts(1_015_880_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 79_267_000 picoseconds.
		Weight::from_parts(48_535_980, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 266_573
			.saturating_add(Weight::from_parts(61_139_400, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		// Minimum execution time: 69_349_000 picoseconds.
		Weight::from_parts(33_371_041, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 165_235
			.saturating_add(Weight::from_parts(54_843_524, 0).saturating_mul(b.into()))
