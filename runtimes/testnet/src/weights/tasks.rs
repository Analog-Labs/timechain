...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 679_333_000 picoseconds.
		Weight::from_parts(706_183_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(70_774_000, 0)
			.saturating_add(Weight::from_parts(0, 4216))
			// Standard Error: 137_171
			.saturating_add(Weight::from_parts(55_072_092, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(24_397_255, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 118_743
			.saturating_add(Weight::from_parts(62_538_253, 0).saturating_mul(b.into()))
