...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 516_576_000 picoseconds.
		Weight::from_parts(550_008_000, 0)
	...
	fn ready() -> Weight {
		...
		//  Measured:  `591`
		//  Estimated: `11481`
		// Minimum execution time: 61_215_000 picoseconds.
		Weight::from_parts(67_376_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `189 + b * (283 ±0)`
		//  Estimated: `3654 + b * (10184 ±0)`
		// Minimum execution time: 83_436_000 picoseconds.
		Weight::from_parts(20_920_881, 0)
			.saturating_add(Weight::from_parts(0, 3654))
			// Standard Error: 344_942
			.saturating_add(Weight::from_parts(78_917_589, 0).saturating_mul(b.into()))
