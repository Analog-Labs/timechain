...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 326_601_000 picoseconds.
		Weight::from_parts(328_043_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(86_933_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(15_619_565, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 156_606
			.saturating_add(Weight::from_parts(91_696_938, 0).saturating_mul(b.into()))
