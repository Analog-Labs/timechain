...
impl<T: frame_system::Config> pallet_elections::WeightInfo for WeightInfo<T> {
	...
	fn try_elect_shards(b: u32, ) -> Weight {
		...
		// Minimum execution time: 73_586_000 picoseconds.
		Weight::from_parts(75_852_000, 0)
			.saturating_add(Weight::from_parts(0, 3657))
			// Standard Error: 499_524
			.saturating_add(Weight::from_parts(183_117_782, 0).saturating_mul(b.into()))
