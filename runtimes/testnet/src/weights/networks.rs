...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(59_222_633, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 7_746
			.saturating_add(Weight::from_parts(39_981, 0).saturating_mul(a.into()))
			// Standard Error: 7_746
			.saturating_add(Weight::from_parts(49_009, 0).saturating_mul(b.into()))
