...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 516_055_000 picoseconds.
		Weight::from_parts(539_468_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(64_501_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(113_673_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_709_977, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 168_995
			.saturating_add(Weight::from_parts(98_883_025, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
