...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn send_heartbeat() -> Weight {
		...
		//  Measured:  `500`
		//  Estimated: `3965`
		// Minimum execution time: 45_385_000 picoseconds.
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(65_594_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(39_745_000, 0)
			...
			// Standard Error: 41_987
			.saturating_add(Weight::from_parts(21_161_412, 0).saturating_mul(b.into()))
