// TODO: delete once task_queue is done
use frame_support::storage::{StorageMap, StorageValue};
use codec::{Codec, EncodeLike};
use core::marker::PhantomData;

/// Trait object presenting the task queue interface.
pub trait TaskQueue<Item>
where
	Item: Codec + EncodeLike,
{
    // fn take(network: Network, count: usize) -> Vec<Item>;
    // fn remove(network: Network, )
