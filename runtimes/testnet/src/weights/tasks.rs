...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 651_238_000 picoseconds.
		Weight::from_parts(728_643_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(75_692_000, 0)
			...
			// Standard Error: 156_795
			.saturating_add(Weight::from_parts(62_030_863, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		// Minimum execution time: 71_573_000 picoseconds.
		Weight::from_parts(32_309_556, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 141_345
			.saturating_add(Weight::from_parts(55_078_778, 0).saturating_mul(b.into()))
