...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 271_117_000 picoseconds.
		Weight::from_parts(272_299_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(51_937_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(9_408_576, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 39_382
			.saturating_add(Weight::from_parts(49_136_490, 0).saturating_mul(b.into()))
