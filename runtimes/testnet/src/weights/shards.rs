...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 520_264_000 picoseconds.
		Weight::from_parts(562_302_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(68_979_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `459`
		//  Estimated: `11349`
		// Minimum execution time: 117_178_000 picoseconds.
		Weight::from_parts(124_394_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 124_143_000 picoseconds.
		Weight::from_parts(26_099_371, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 146_310
			.saturating_add(Weight::from_parts(110_710_491, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
