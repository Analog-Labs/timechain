...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		//  Measured:  `359`
		//  Estimated: `21149`
		// Minimum execution time: 48_731_000 picoseconds.
		Weight::from_parts(56_547_801, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 961
			.saturating_add(Weight::from_parts(5_769, 0).saturating_mul(a.into()))
			// Standard Error: 961
			.saturating_add(Weight::from_parts(3_322, 0).saturating_mul(b.into()))
