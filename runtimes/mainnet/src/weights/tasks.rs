...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 661_829_000 picoseconds.
		Weight::from_parts(694_458_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 74_500_000 picoseconds.
		Weight::from_parts(76_183_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 75_677
			.saturating_add(Weight::from_parts(62_197_923, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(27_397_063, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 195_173
			.saturating_add(Weight::from_parts(59_329_010, 0).saturating_mul(b.into()))
