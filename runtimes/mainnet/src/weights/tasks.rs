...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 641_470_000 picoseconds.
		Weight::from_parts(673_781_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(4_515_099, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 114_415
			.saturating_add(Weight::from_parts(63_112_516, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		// Minimum execution time: 73_256_000 picoseconds.
		Weight::from_parts(23_392_508, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 123_508
			.saturating_add(Weight::from_parts(58_434_486, 0).saturating_mul(b.into()))
