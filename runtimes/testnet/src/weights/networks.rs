...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(57_013_394, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 2_798
			.saturating_add(Weight::from_parts(20_508, 0).saturating_mul(a.into()))
			// Standard Error: 2_798
			.saturating_add(Weight::from_parts(6_958, 0).saturating_mul(b.into()))
