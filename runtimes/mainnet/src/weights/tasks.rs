...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 629_707_000 picoseconds.
		Weight::from_parts(686_184_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(135_064_095, 0)
			.saturating_add(Weight::from_parts(0, 9197))
			// Standard Error: 100
			.saturating_add(Weight::from_parts(8_089, 0).saturating_mul(b.into()))
