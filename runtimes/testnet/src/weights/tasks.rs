...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 653_243_000 picoseconds.
		Weight::from_parts(713_325_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 72_355_000 picoseconds.
		Weight::from_parts(77_204_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 174_147
			.saturating_add(Weight::from_parts(63_628_194, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(31_287_861, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 266_738
			.saturating_add(Weight::from_parts(58_125_631, 0).saturating_mul(b.into()))
