...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 623_897_000 picoseconds.
		Weight::from_parts(638_574_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		//  Measured:  `3665`
		//  Estimated: `9197`
		// Minimum execution time: 74_490_000 picoseconds.
		Weight::from_parts(135_321_848, 0)
			.saturating_add(Weight::from_parts(0, 9197))
			// Standard Error: 106
			.saturating_add(Weight::from_parts(8_091, 0).saturating_mul(b.into()))
