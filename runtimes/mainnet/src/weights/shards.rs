...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 514_622_000 picoseconds.
		Weight::from_parts(567_832_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(65_651_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(124_243_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 129_863_000 picoseconds.
		Weight::from_parts(100_434_728, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 1_092_122
			.saturating_add(Weight::from_parts(102_596_781, 0).saturating_mul(b.into()))
