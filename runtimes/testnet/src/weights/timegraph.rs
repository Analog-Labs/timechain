...
impl<T: frame_system::Config> pallet_timegraph::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		//  Measured:  `192`
		//  Estimated: `3657`
		// Minimum execution time: 65_523_000 picoseconds.
		Weight::from_parts(66_995_000, 0)
	...
	fn withdraw() -> Weight {
		...
		//  Measured:  `192`
		//  Estimated: `3657`
		// Minimum execution time: 65_222_000 picoseconds.
		Weight::from_parts(66_564_000, 0)
			.saturating_add(Weight::from_parts(0, 3657))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
