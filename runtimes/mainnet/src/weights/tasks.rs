...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 656_028_000 picoseconds.
		Weight::from_parts(733_642_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(81_351_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 139_879
			.saturating_add(Weight::from_parts(66_487_785, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_357_700, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 230_111
			.saturating_add(Weight::from_parts(67_770_488, 0).saturating_mul(b.into()))
