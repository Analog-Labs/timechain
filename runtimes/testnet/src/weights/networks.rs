...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(61_130_169, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 737
			.saturating_add(Weight::from_parts(1_530, 0).saturating_mul(a.into()))
			// Standard Error: 737
			.saturating_add(Weight::from_parts(9_097, 0).saturating_mul(b.into()))
