...
impl<T: frame_system::Config> pallet_dmail::WeightInfo for WeightInfo<T> {
	...
	fn send_email(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(9_517_355, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 219
			.saturating_add(Weight::from_parts(1_012, 0).saturating_mul(a.into()))
			// Standard Error: 219
			.saturating_add(Weight::from_parts(4_077, 0).saturating_mul(b.into()))
	}
}
