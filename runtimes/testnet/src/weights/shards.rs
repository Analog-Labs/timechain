...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 516_005_000 picoseconds.
		Weight::from_parts(531_554_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(66_052_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `459`
		//  Estimated: `11349`
		// Minimum execution time: 113_832_000 picoseconds.
		Weight::from_parts(119_042_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 121_747_000 picoseconds.
		Weight::from_parts(21_719_436, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 435_134
			.saturating_add(Weight::from_parts(112_500_789, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
