...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(55_666_940, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 9_831
			.saturating_add(Weight::from_parts(34_555, 0).saturating_mul(a.into()))
			// Standard Error: 9_831
			.saturating_add(Weight::from_parts(40_085, 0).saturating_mul(b.into()))
