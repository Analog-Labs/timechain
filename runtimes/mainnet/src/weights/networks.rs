...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(43_711_315, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 1_142
			.saturating_add(Weight::from_parts(9_117, 0).saturating_mul(a.into()))
			// Standard Error: 1_142
			.saturating_add(Weight::from_parts(9_205, 0).saturating_mul(b.into()))
