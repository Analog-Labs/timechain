...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		Weight::from_parts(52_479_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(78_728_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(13_900_421, 0)
			.saturating_add(Weight::from_parts(0, 3809))
			// Standard Error: 64_038
			.saturating_add(Weight::from_parts(23_441_786, 0).saturating_mul(b.into()))
