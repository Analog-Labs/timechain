...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 518_069_000 picoseconds.
		Weight::from_parts(542_776_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(83_887_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `459`
		//  Estimated: `11349`
		// Minimum execution time: 107_230_000 picoseconds.
		Weight::from_parts(114_834_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 115_315_000 picoseconds.
		Weight::from_parts(16_999_614, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 661_138
			.saturating_add(Weight::from_parts(110_123_598, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
