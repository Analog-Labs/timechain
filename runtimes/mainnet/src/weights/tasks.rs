...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1499`
		//  Estimated: `12389`
		// Minimum execution time: 622_144_000 picoseconds.
		Weight::from_parts(649_926_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(73_337_000, 0)
			...
			// Standard Error: 91_796
			.saturating_add(Weight::from_parts(70_620_972, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		// Minimum execution time: 70_672_000 picoseconds.
		Weight::from_parts(72_175_000, 0)
			.saturating_add(Weight::from_parts(0, 4498))
			// Standard Error: 75_206
			.saturating_add(Weight::from_parts(64_490_026, 0).saturating_mul(b.into()))
