...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 644_025_000 picoseconds.
		Weight::from_parts(671_297_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(75_361_000, 0)
			...
			// Standard Error: 55_311
			.saturating_add(Weight::from_parts(57_361_943, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_780_724, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 73_409
			.saturating_add(Weight::from_parts(54_734_463, 0).saturating_mul(b.into()))
