...
fn mock_result_ok(shard_id: ShardId) -> TaskResult {
	...
	TaskResult {
		shard_id,
		hash: [11, 210, 118, 190, 192, 58, 251, 12, 81, 99, 159, 107, 191, 242, 96, 233, 203, 127, 91, 0, 219, 14, 241, 19, 45, 124, 246, 145, 176, 169, 138, 11],
		signature: [196, 97, 193, 244, 167, 64, 220, 164, 96, 72, 191, 222, 230, 48, 188, 45, 36, 98, 135, 148, 210, 252, 64, 5, 143, 222, 105, 229, 85, 45, 214, 253, 198, 248, 57, 75, 26, 186, 131, 195, 9, 4, 74, 33, 247, 130, 248, 71, 140, 237, 153, 82, 248, 124, 78, 245, 18, 185, 126, 32, 11, 210, 193, 48],
	}
}
...
fn mock_error_result(shard_id: ShardId) -> TaskError{
	...
	TaskError{
		...
		signature: [46, 103, 15, 236, 204, 108, 113, 94, 241, 4, 159, 152, 118, 95, 232, 215, 91, 198, 214, 239, 85, 16, 143, 134, 114, 200, 38, 136, 205, 23, 145, 90, 178, 216, 139, 123, 140, 95, 106, 243, 245, 5, 76, 210, 119, 221, 28, 253, 217, 79, 71, 255, 90, 216, 164, 157, 68, 116, 211, 23, 223, 79, 30, 250],
	}
}
