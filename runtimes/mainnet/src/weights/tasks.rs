...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 318_866_000 picoseconds.
		Weight::from_parts(320_740_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(33_763_000, 0)
			...
			// Standard Error: 15_219
			.saturating_add(Weight::from_parts(26_883_938, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(7_640_053, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 10_435
			.saturating_add(Weight::from_parts(24_249_862, 0).saturating_mul(b.into()))
