...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(57_548_860, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 9_638
			.saturating_add(Weight::from_parts(72_111, 0).saturating_mul(a.into()))
			// Standard Error: 9_638
			.saturating_add(Weight::from_parts(120_990, 0).saturating_mul(b.into()))
