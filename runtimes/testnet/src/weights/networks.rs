...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, _b: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3583`
		// Minimum execution time: 60_925_000 picoseconds.
		Weight::from_parts(81_324_887, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 21_099
			.saturating_add(Weight::from_parts(7_242, 0).saturating_mul(a.into()))
	...
	fn remove_network() -> Weight {
		...
		Weight::from_parts(17_682_000, 0)
