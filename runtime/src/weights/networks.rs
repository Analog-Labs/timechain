...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(52_370_058, 0)
			.saturating_add(Weight::from_parts(0, 21205))
			// Standard Error: 488
			.saturating_add(Weight::from_parts(4_754, 0).saturating_mul(a.into()))
			// Standard Error: 488
			.saturating_add(Weight::from_parts(5_640, 0).saturating_mul(b.into()))
