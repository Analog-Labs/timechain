...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 522_156_000 picoseconds.
		Weight::from_parts(558_836_000, 0)
	...
	fn ready() -> Weight {
		...
		//  Measured:  `557`
		//  Estimated: `11447`
		// Minimum execution time: 62_117_000 picoseconds.
		Weight::from_parts(69_068_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(92_313_000, 0)
