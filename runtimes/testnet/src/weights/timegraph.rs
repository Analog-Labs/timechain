...
impl<T: frame_system::Config> pallet_timegraph::WeightInfo for WeightInfo<T> {
	...
	fn deposit() -> Weight {
		...
		Weight::from_parts(56_506_000, 0)
	...
	fn withdraw() -> Weight {
		...
		Weight::from_parts(56_316_000, 0)
			.saturating_add(Weight::from_parts(0, 3468))
	...
	fn transfer_to_pool() -> Weight {
		...
		//  Measured:  `272`
		//  Estimated: `6196`
		// Minimum execution time: 92_754_000 picoseconds.
		Weight::from_parts(135_033_000, 0)
	...
	fn transfer_award_to_user() -> Weight {
		...
		Weight::from_parts(126_637_000, 0)
