...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		Weight::from_parts(686_694_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(62_126_000, 0)
			...
			.saturating_add(Weight::from_parts(11_935_194, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(46_252_164, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 461
			.saturating_add(Weight::from_parts(13_225, 0).saturating_mul(b.into()))
