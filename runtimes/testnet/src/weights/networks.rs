...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(63_670_641, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 9_742
			.saturating_add(Weight::from_parts(39_739, 0).saturating_mul(a.into()))
			// Standard Error: 9_742
			.saturating_add(Weight::from_parts(73_260, 0).saturating_mul(b.into()))
