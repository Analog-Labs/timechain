...
impl<T: frame_system::Config> pallet_elections::WeightInfo for WeightInfo<T> {
	...
	fn try_elect_shards(b: u32, ) -> Weight {
		...
		// Minimum execution time: 42_591_000 picoseconds.
		Weight::from_parts(18_695_397, 0)
			.saturating_add(Weight::from_parts(0, 3637))
			// Standard Error: 44_919
			.saturating_add(Weight::from_parts(29_457_675, 0).saturating_mul(b.into()))
