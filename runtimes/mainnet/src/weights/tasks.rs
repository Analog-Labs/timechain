...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 669_945_000 picoseconds.
		Weight::from_parts(725_091_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(1_852_258, 0)
			.saturating_add(Weight::from_parts(0, 4216))
			// Standard Error: 143_104
			.saturating_add(Weight::from_parts(54_007_212, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_411_410, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 91_606
			.saturating_add(Weight::from_parts(58_982_781, 0).saturating_mul(b.into()))
