...
impl<T: frame_system::Config> pallet_elections::WeightInfo for WeightInfo<T> {
	...
	fn try_elect_shard(b: u32, ) -> Weight {
		...
		// Minimum execution time: 77_134_000 picoseconds.
		Weight::from_parts(79_981_000, 0)
			.saturating_add(Weight::from_parts(0, 3651))
			// Standard Error: 120_669
			.saturating_add(Weight::from_parts(48_762_796, 0).saturating_mul(b.into()))
