...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 631_241_000 picoseconds.
		Weight::from_parts(657_129_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_399_092, 0)
			.saturating_add(Weight::from_parts(0, 7370))
			// Standard Error: 8_607
			.saturating_add(Weight::from_parts(10_574_574, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(40_436_719, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 313
			.saturating_add(Weight::from_parts(16_793, 0).saturating_mul(b.into()))
