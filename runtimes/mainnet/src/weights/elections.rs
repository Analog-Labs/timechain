...
impl<T: frame_system::Config> pallet_elections::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `Shards::ShardState` (r:0 w:102)
	...
	fn try_elect_shards(b: u32, ) -> Weight {
		...
		Weight::from_parts(55_156_251, 0)
			.saturating_add(Weight::from_parts(0, 3637))
			// Standard Error: 44_033
			.saturating_add(Weight::from_parts(34_811_569, 0).saturating_mul(b.into()))
