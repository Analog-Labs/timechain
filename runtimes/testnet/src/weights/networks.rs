...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		//  Measured:  `359`
		//  Estimated: `21149`
		// Minimum execution time: 48_029_000 picoseconds.
		Weight::from_parts(52_900_604, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 830
			.saturating_add(Weight::from_parts(6_675, 0).saturating_mul(a.into()))
			// Standard Error: 830
			.saturating_add(Weight::from_parts(2_151, 0).saturating_mul(b.into()))
