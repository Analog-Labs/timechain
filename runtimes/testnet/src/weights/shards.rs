...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 519_160_000 picoseconds.
		Weight::from_parts(524_040_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(66_034_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `459`
		//  Estimated: `11349`
		// Minimum execution time: 110_156_000 picoseconds.
		Weight::from_parts(118_771_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 120_485_000 picoseconds.
		Weight::from_parts(26_903_007, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 475_450
			.saturating_add(Weight::from_parts(109_221_942, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
