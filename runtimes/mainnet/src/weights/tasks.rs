...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 625_850_000 picoseconds.
		Weight::from_parts(651_048_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(40_535_221, 0)
			.saturating_add(Weight::from_parts(0, 7370))
			// Standard Error: 15_013
			.saturating_add(Weight::from_parts(10_375_135, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(40_636_421, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 320
			.saturating_add(Weight::from_parts(18_435, 0).saturating_mul(b.into()))
