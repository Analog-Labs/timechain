...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(38_967_801, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 1_383
			.saturating_add(Weight::from_parts(26_351, 0).saturating_mul(a.into()))
			// Standard Error: 1_383
			.saturating_add(Weight::from_parts(13_585, 0).saturating_mul(b.into()))
