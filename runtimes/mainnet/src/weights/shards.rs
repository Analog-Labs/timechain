...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `828`
		//  Estimated: `11718`
		// Minimum execution time: 521_958_000 picoseconds.
		Weight::from_parts(535_884_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(65_432_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `712`
		//  Estimated: `11602`
		// Minimum execution time: 117_219_000 picoseconds.
		Weight::from_parts(120_918_000, 0)
