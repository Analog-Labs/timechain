...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1381`
		//  Estimated: `12271`
		// Minimum execution time: 661_105_000 picoseconds.
		Weight::from_parts(739_063_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(146_706_263, 0)
			.saturating_add(Weight::from_parts(0, 9197))
			// Standard Error: 109
			.saturating_add(Weight::from_parts(7_616, 0).saturating_mul(b.into()))
