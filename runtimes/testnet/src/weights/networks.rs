...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(58_474_141, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 622
			.saturating_add(Weight::from_parts(4_192, 0).saturating_mul(a.into()))
			// Standard Error: 622
			.saturating_add(Weight::from_parts(103, 0).saturating_mul(b.into()))
