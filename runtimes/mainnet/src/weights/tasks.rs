...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 621_113_000 picoseconds.
		Weight::from_parts(632_674_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(62_858_000, 0)
			.saturating_add(Weight::from_parts(0, 8309))
			// Standard Error: 4_891
			.saturating_add(Weight::from_parts(10_569_998, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(45_243_749, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 409
			.saturating_add(Weight::from_parts(12_293, 0).saturating_mul(b.into()))
