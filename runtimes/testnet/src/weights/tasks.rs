...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 635_718_000 picoseconds.
		Weight::from_parts(755_002_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(73_237_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 78_320
			.saturating_add(Weight::from_parts(57_076_839, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_536_210, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 81_751
			.saturating_add(Weight::from_parts(52_056_600, 0).saturating_mul(b.into()))
