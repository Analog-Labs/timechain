...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(51_615_601, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 261
			.saturating_add(Weight::from_parts(251, 0).saturating_mul(a.into()))
			// Standard Error: 261
			.saturating_add(Weight::from_parts(186, 0).saturating_mul(b.into()))
