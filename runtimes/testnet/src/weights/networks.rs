...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(45_842_626, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 630
			.saturating_add(Weight::from_parts(6_672, 0).saturating_mul(a.into()))
			// Standard Error: 630
			.saturating_add(Weight::from_parts(5_467, 0).saturating_mul(b.into()))
