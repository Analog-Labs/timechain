...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 634_928_000 picoseconds.
		Weight::from_parts(663_703_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(68_452_192, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 420_804
			.saturating_add(Weight::from_parts(63_934_203, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(30_003_796, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 212_789
			.saturating_add(Weight::from_parts(60_211_988, 0).saturating_mul(b.into()))
