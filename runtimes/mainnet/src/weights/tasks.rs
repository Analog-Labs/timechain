...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		Weight::from_parts(674_942_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(73_077_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 53_517
			.saturating_add(Weight::from_parts(58_028_924, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(33_005_225, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 118_722
			.saturating_add(Weight::from_parts(52_912_708, 0).saturating_mul(b.into()))
