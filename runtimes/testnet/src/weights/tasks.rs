...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 654_504_000 picoseconds.
		Weight::from_parts(679_862_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(21_728_383, 0)
			.saturating_add(Weight::from_parts(0, 7370))
			// Standard Error: 10_790
			.saturating_add(Weight::from_parts(11_091_598, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(45_495_436, 0)
