...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 516_647_000 picoseconds.
		Weight::from_parts(548_987_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(64_089_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_962_149, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 468_058
			.saturating_add(Weight::from_parts(104_443_817, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
