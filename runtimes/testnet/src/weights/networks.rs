...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(47_622_813, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 178
			.saturating_add(Weight::from_parts(2_506, 0).saturating_mul(a.into()))
			// Standard Error: 178
			.saturating_add(Weight::from_parts(2_372, 0).saturating_mul(b.into()))
