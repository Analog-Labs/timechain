...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(53_225_243, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 951
			.saturating_add(Weight::from_parts(14_180, 0).saturating_mul(a.into()))
			// Standard Error: 951
			.saturating_add(Weight::from_parts(8_256, 0).saturating_mul(b.into()))
