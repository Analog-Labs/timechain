...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn send_heartbeat() -> Weight {
		...
		Weight::from_parts(61_916_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `329 + b * (174 ±0)`
		//  Estimated: `3793 + b * (2649 ±0)`
		// Minimum execution time: 60_533_000 picoseconds.
		Weight::from_parts(43_756_387, 0)
			.saturating_add(Weight::from_parts(0, 3793))
			// Standard Error: 166_247
			.saturating_add(Weight::from_parts(24_194_015, 0).saturating_mul(b.into()))
