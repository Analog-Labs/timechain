...
pub mod pallet {
	...
	use time_primitives::{
		...
		sharding::{
			EligibleShard, IncrementTaskTimeoutCount, Network, ReassignShardTasks, ShardId,
		},
	...
	pub trait Config: CreateSignedTransaction<Call<Self>> + frame_system::Config {
		...
		type ShardEligibility: EligibleShard<ShardId, Network>;
		type ShardTimeouts: IncrementTaskTimeoutCount<ShardId>;
	...
	impl<T: Config> ReassignShardTasks<ShardId> for Pallet<T> {
		fn reassign_shard_tasks(id: ShardId) {
