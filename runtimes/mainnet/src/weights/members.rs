...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		//  Measured:  `109`
		//  Estimated: `3593`
		// Minimum execution time: 47_768_000 picoseconds.
	...
	fn send_heartbeat() -> Weight {
		...
		Weight::from_parts(49_413_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(491_102, 0)
			.saturating_add(Weight::from_parts(0, 3829))
			// Standard Error: 68_766
			.saturating_add(Weight::from_parts(22_399_744, 0).saturating_mul(b.into()))
