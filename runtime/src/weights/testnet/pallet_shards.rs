...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 557_941_000 picoseconds.
		Weight::from_parts(575_433_000, 0)
	...
	fn ready() -> Weight {
		...
		//  Measured:  `657`
		//  Estimated: `11547`
		// Minimum execution time: 86_140_000 picoseconds.
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(209_199_924, 0)
			.saturating_add(Weight::from_parts(0, 8889))
			// Standard Error: 7_072_393
			.saturating_add(Weight::from_parts(169_029_050, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(6))
