...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 660_315_000 picoseconds.
		Weight::from_parts(697_093_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(77_083_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 149_046
			.saturating_add(Weight::from_parts(64_265_810, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(19_842_115, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 92_810
			.saturating_add(Weight::from_parts(59_821_682, 0).saturating_mul(b.into()))
