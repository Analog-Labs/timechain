...
impl<T: frame_system::Config> pallet_dmail::WeightInfo for WeightInfo<T> {
	...
	fn send_email(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(9_606_857, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 1_599
			.saturating_add(Weight::from_parts(10_503, 0).saturating_mul(a.into()))
			// Standard Error: 1_599
			.saturating_add(Weight::from_parts(5_718, 0).saturating_mul(b.into()))
	}
}
