...
/// Weight functions needed for `pallet_networks`.
pub trait WeightInfo {
	fn add_network(a: u32, b: u32, ) -> Weight;
}

/// Weights for `pallet_networks` using the Substrate node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_network(a: u32, _b: u32, ) -> Weight {
		...
		Weight::from_parts(52_672_744, 21149)
			// Standard Error: 176
			.saturating_add(Weight::from_parts(152, 0).saturating_mul(a.into()))
