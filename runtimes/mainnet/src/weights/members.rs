...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn send_heartbeat() -> Weight {
		...
		//  Measured:  `377`
		//  Estimated: `3842`
		// Minimum execution time: 40_595_000 picoseconds.
		Weight::from_parts(43_392_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(64_532_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(22_818_775, 0)
			.saturating_add(Weight::from_parts(0, 3637))
			// Standard Error: 33_331
			.saturating_add(Weight::from_parts(19_020_861, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2))
