...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 518_020_000 picoseconds.
		Weight::from_parts(544_518_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(67_116_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(121_727_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 121_639_000 picoseconds.
		Weight::from_parts(29_579_950, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 438_118
			.saturating_add(Weight::from_parts(114_535_608, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
