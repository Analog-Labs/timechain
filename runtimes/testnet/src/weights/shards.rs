...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 515_554_000 picoseconds.
		Weight::from_parts(531_974_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(64_609_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(85_951_000, 0)
			.saturating_add(Weight::from_parts(0, 3658))
			// Standard Error: 62_407
			.saturating_add(Weight::from_parts(77_363_074, 0).saturating_mul(b.into()))
