...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 518_160_000 picoseconds.
		Weight::from_parts(556_883_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(130_144_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 130_945_000 picoseconds.
		Weight::from_parts(19_713_663, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 337_920
			.saturating_add(Weight::from_parts(121_214_092, 0).saturating_mul(b.into()))
