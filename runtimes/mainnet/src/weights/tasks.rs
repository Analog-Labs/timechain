...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 649_776_000 picoseconds.
		Weight::from_parts(704_768_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(76_343_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 114_441
			.saturating_add(Weight::from_parts(63_070_632, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		// Minimum execution time: 71_402_000 picoseconds.
		Weight::from_parts(26_574_559, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 221_647
			.saturating_add(Weight::from_parts(59_721_283, 0).saturating_mul(b.into()))
