...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 626_582_000 picoseconds.
		Weight::from_parts(652_250_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(28_955_416, 0)
			.saturating_add(Weight::from_parts(0, 7370))
			// Standard Error: 10_399
			.saturating_add(Weight::from_parts(10_400_668, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(38_785_919, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 285
			.saturating_add(Weight::from_parts(19_047, 0).saturating_mul(b.into()))
