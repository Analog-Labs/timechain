...
impl<T: frame_system::Config> pallet_dmail::WeightInfo for WeightInfo<T> {
	...
	fn send_email(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(9_593_701, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 504
			.saturating_add(Weight::from_parts(1_627, 0).saturating_mul(a.into()))
			// Standard Error: 504
			.saturating_add(Weight::from_parts(5_458, 0).saturating_mul(b.into()))
	}
}
