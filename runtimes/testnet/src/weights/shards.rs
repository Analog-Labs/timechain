...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 529_880_000 picoseconds.
		Weight::from_parts(542_294_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `459`
		//  Estimated: `11349`
		// Minimum execution time: 110_917_000 picoseconds.
		Weight::from_parts(116_047_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 117_158_000 picoseconds.
		Weight::from_parts(29_695_565, 0)
			.saturating_add(Weight::from_parts(0, 8610))
			// Standard Error: 146_148
			.saturating_add(Weight::from_parts(104_020_495, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(7))
