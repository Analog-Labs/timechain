...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn send_heartbeat() -> Weight {
		...
		Weight::from_parts(45_566_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		//  Measured:  `518`
		//  Estimated: `3983`
		// Minimum execution time: 60_994_000 picoseconds.
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(55_409_415, 0)
			.saturating_add(Weight::from_parts(0, 3829))
			// Standard Error: 80_568
			.saturating_add(Weight::from_parts(20_714_747, 0).saturating_mul(b.into()))
