...
impl<T: frame_system::Config> pallet_dmail::WeightInfo for WeightInfo<T> {
	...
	fn send_email(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(6_457_675, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 1_307
			.saturating_add(Weight::from_parts(19_455, 0).saturating_mul(a.into()))
			// Standard Error: 1_307
			.saturating_add(Weight::from_parts(25_413, 0).saturating_mul(b.into()))
	}
}
