...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		//  Measured:  `118`
		//  Estimated: `3583`
		// Minimum execution time: 61_024_000 picoseconds.
		Weight::from_parts(65_789_392, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 22_269
			.saturating_add(Weight::from_parts(349_761, 0).saturating_mul(a.into()))
			// Standard Error: 22_269
			.saturating_add(Weight::from_parts(4_621, 0).saturating_mul(b.into()))
