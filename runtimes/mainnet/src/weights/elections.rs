...
impl<T: frame_system::Config> pallet_elections::WeightInfo for WeightInfo<T> {
	...
	fn try_elect_shards(b: u32, ) -> Weight {
		...
		// Minimum execution time: 74_549_000 picoseconds.
		Weight::from_parts(76_252_000, 0)
			.saturating_add(Weight::from_parts(0, 3657))
			// Standard Error: 235_806
			.saturating_add(Weight::from_parts(165_879_580, 0).saturating_mul(b.into()))
