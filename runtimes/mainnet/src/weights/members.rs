...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		Weight::from_parts(55_254_000, 0)
	...
	fn send_heartbeat() -> Weight {
		...
		//  Measured:  `377`
		//  Estimated: `3842`
		// Minimum execution time: 39_603_000 picoseconds.
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(71_724_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `336 + b * (124 ±0)`
		//  Estimated: `3793 + b * (2600 ±0)`
		// Minimum execution time: 35_176_000 picoseconds.
		Weight::from_parts(15_523_831, 0)
			.saturating_add(Weight::from_parts(0, 3793))
			// Standard Error: 200_903
			.saturating_add(Weight::from_parts(25_446_094, 0).saturating_mul(b.into()))
			...
			.saturating_add(Weight::from_parts(0, 2600).saturating_mul(b.into()))
	}
}
