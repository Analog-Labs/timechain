...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 519_513_000 picoseconds.
		Weight::from_parts(548_656_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(70_322_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `453`
		//  Estimated: `11343`
		// Minimum execution time: 71_324_000 picoseconds.
		Weight::from_parts(79_960_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		Weight::from_parts(16_126_469, 0)
			.saturating_add(Weight::from_parts(0, 3659))
			// Standard Error: 303_470
			.saturating_add(Weight::from_parts(77_518_214, 0).saturating_mul(b.into()))
