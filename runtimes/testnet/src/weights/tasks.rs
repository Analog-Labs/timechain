...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 648_423_000 picoseconds.
		Weight::from_parts(693_318_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(78_026_000, 0)
			...
			// Standard Error: 187_963
			.saturating_add(Weight::from_parts(63_733_371, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(72_765_000, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 249_303
			.saturating_add(Weight::from_parts(53_710_668, 0).saturating_mul(b.into()))
	...
	fn remove_task() -> Weight {
		...
		Weight::from_parts(25_156_000, 0)
