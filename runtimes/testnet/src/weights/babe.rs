...
impl<T: frame_system::Config> pallet_babe::WeightInfo for WeightInfo<T> {
	...
	fn check_equivocation_proof(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 98_003_000 picoseconds.
		Weight::from_parts(103_962_393, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 829_892
			.saturating_add(Weight::from_parts(1_776_306, 0).saturating_mul(x.into()))
	}
}
