...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `790`
		//  Estimated: `11680`
		// Minimum execution time: 514_543_000 picoseconds.
		Weight::from_parts(538_697_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(86_522_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		//  Measured:  `615`
		//  Estimated: `11505`
		// Minimum execution time: 117_349_000 picoseconds.
		Weight::from_parts(173_525_000, 0)
			.saturating_add(Weight::from_parts(0, 11505))
			.saturating_add(T::DbWeight::get().reads(14))
			.saturating_add(T::DbWeight::get().writes(21))
	}
	/// Storage: `Shards::DkgTimeout` (r:6 w:5)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `371 + b * (279 ±0)`
		//  Estimated: `8786 + b * (10180 ±0)`
		// Minimum execution time: 126_246_000 picoseconds.
		Weight::from_parts(9_716_212, 0)
			.saturating_add(Weight::from_parts(0, 8786))
			// Standard Error: 766_059
			.saturating_add(Weight::from_parts(122_354_036, 0).saturating_mul(b.into()))
			...
			.saturating_add(Weight::from_parts(0, 10180).saturating_mul(b.into()))
	}
}
