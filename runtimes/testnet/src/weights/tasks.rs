...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 630_600_000 picoseconds.
		Weight::from_parts(661_006_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_552_504, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 132_523
			.saturating_add(Weight::from_parts(60_077_442, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(24_295_655, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 90_608
			.saturating_add(Weight::from_parts(53_539_828, 0).saturating_mul(b.into()))
