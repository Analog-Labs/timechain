...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 661_257_000 picoseconds.
		Weight::from_parts(697_746_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 75_873_000 picoseconds.
		Weight::from_parts(9_015_388, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 221_403
			.saturating_add(Weight::from_parts(65_838_776, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(20_474_862, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 464_248
			.saturating_add(Weight::from_parts(63_500_613, 0).saturating_mul(b.into()))
