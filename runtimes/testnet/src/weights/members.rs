...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		Weight::from_parts(66_173_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		//  Measured:  `380`
		//  Estimated: `3845`
		// Minimum execution time: 57_648_000 picoseconds.
		Weight::from_parts(64_812_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(10_395_638, 0)
			.saturating_add(Weight::from_parts(0, 3961))
			// Standard Error: 33_734
			.saturating_add(Weight::from_parts(20_904_535, 0).saturating_mul(b.into()))
