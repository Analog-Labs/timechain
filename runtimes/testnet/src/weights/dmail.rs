...
impl<T: frame_system::Config> pallet_dmail::WeightInfo for WeightInfo<T> {
	...
	fn send_email(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(6_119_149, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 160
			.saturating_add(Weight::from_parts(3_265, 0).saturating_mul(a.into()))
			// Standard Error: 160
			.saturating_add(Weight::from_parts(3_186, 0).saturating_mul(b.into()))
	}
}
