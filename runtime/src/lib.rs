...
pub use runtime_common::constants::{ANLOG, TOCK};
...
pub use pallet_transaction_payment::{ConstFeeMultiplier, CurrencyAdapter, Multiplier};
...
impl Contains<Call> for BaseFilter{
	fn contains(c: &Call) -> bool {
		...
		// 	Call::TesseractSigStorage(_) => true,
		// 	_ => false,
		// }
		true
	}
...
parameter_types! {
	...
	pub const SignedDepositBase: Balance = 1 * ANLOG;
	pub const SignedDepositByte: Balance = 1 * TOCK;
...
parameter_types! {
	...
	pub const DataDepositPerByte: Balance = 1 * TOCK;
...
parameter_types! {
	...
	pub const PreimageBaseDeposit: Balance = 1 * ANLOG;
	// One cent: $10,000 / MB
	pub const PreimageByteDeposit: Balance = 1 * TOCK;
}
