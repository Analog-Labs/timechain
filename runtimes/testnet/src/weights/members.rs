...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		Weight::from_parts(49_423_000, 0)
	...
	fn send_heartbeat() -> Weight {
		...
		//  Measured:  `377`
		//  Estimated: `3842`
		// Minimum execution time: 40_676_000 picoseconds.
		Weight::from_parts(45_416_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(67_075_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(18_563_654, 0)
			.saturating_add(Weight::from_parts(0, 3637))
			// Standard Error: 32_684
			.saturating_add(Weight::from_parts(19_175_542, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(2))
