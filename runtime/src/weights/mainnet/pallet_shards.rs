...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 271_087_000 picoseconds.
		Weight::from_parts(272_681_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(51_857_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 54_342_000 picoseconds.
		Weight::from_parts(9_338_745, 0)
			.saturating_add(Weight::from_parts(0, 8733))
			// Standard Error: 40_113
			.saturating_add(Weight::from_parts(47_759_223, 0).saturating_mul(b.into()))
