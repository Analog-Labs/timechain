...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 665_686_000 picoseconds.
		Weight::from_parts(705_541_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(80_249_000, 0)
			.saturating_add(Weight::from_parts(0, 4183))
			// Standard Error: 172_026
			.saturating_add(Weight::from_parts(65_625_974, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_014_629, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 206_571
			.saturating_add(Weight::from_parts(62_380_254, 0).saturating_mul(b.into()))
