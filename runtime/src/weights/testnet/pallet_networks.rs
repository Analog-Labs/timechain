...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn register_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(39_001_541, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 642
			.saturating_add(Weight::from_parts(4_305, 0).saturating_mul(a.into()))
			// Standard Error: 642
			.saturating_add(Weight::from_parts(4_415, 0).saturating_mul(b.into()))
