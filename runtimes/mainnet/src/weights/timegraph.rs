...
impl<T: frame_system::Config> pallet_timegraph::WeightInfo for WeightInfo<T> {
	...
	fn withdraw() -> Weight {
		...
		Weight::from_parts(65_713_000, 0)
			.saturating_add(Weight::from_parts(0, 3593))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn transfer_to_pool() -> Weight {
		...
		//  Measured:  `272`
		//  Estimated: `6196`
		// Minimum execution time: 84_187_000 picoseconds.
		Weight::from_parts(85_631_000, 0)
	...
	fn transfer_award_to_user() -> Weight {
		...
		//  Measured:  `285`
		//  Estimated: `3593`
		// Minimum execution time: 81_293_000 picoseconds.
		Weight::from_parts(82_704_000, 0)
			.saturating_add(Weight::from_parts(0, 3593))
