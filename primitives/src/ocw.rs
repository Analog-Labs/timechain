use crate::{CycleStatus, Network, ShardId, TaskCycle, TaskError, TaskId, TssPublicKey, LastExecutedBlockNum};
...
pub enum OcwPayload {
	...
	SubmitTaskResult { task_id: TaskId, cycle: TaskCycle, status: CycleStatus,  block: LastExecutedBlockNum},
