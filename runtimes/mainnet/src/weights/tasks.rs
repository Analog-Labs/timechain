...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 642_191_000 picoseconds.
		Weight::from_parts(674_312_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 73_446_000 picoseconds.
		Weight::from_parts(19_566_322, 0)
			.saturating_add(Weight::from_parts(0, 4176))
			// Standard Error: 195_345
			.saturating_add(Weight::from_parts(62_032_762, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_060_788, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 73_441
			.saturating_add(Weight::from_parts(55_788_699, 0).saturating_mul(b.into()))
