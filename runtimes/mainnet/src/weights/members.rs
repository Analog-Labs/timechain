...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		//  Measured:  `244`
		//  Estimated: `3709`
		// Minimum execution time: 65_062_000 picoseconds.
		Weight::from_parts(69_460_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(11_669_205, 0)
			.saturating_add(Weight::from_parts(0, 3793))
			// Standard Error: 28_774
			.saturating_add(Weight::from_parts(22_938_335, 0).saturating_mul(b.into()))
