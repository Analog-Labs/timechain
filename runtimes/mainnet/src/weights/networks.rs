...
impl<T: frame_system::Config> pallet_networks::WeightInfo for WeightInfo<T> {
	...
	fn add_network(a: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(50_430_480, 0)
			.saturating_add(Weight::from_parts(0, 21149))
			// Standard Error: 329
			.saturating_add(Weight::from_parts(1_138, 0).saturating_mul(a.into()))
			// Standard Error: 329
			.saturating_add(Weight::from_parts(3_526, 0).saturating_mul(b.into()))
