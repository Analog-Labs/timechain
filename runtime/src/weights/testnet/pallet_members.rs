...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn send_heartbeat() -> Weight {
		...
		Weight::from_parts(48_291_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		...
		Weight::from_parts(46_918_273, 0)
			.saturating_add(Weight::from_parts(0, 3760))
			// Standard Error: 128_889
			.saturating_add(Weight::from_parts(19_938_124, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3))
