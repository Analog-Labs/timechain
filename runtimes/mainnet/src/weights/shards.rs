...
impl<T: frame_system::Config> pallet_shards::WeightInfo for WeightInfo<T> {
	...
	fn commit() -> Weight {
		...
		//  Measured:  `757`
		//  Estimated: `11647`
		// Minimum execution time: 512_870_000 picoseconds.
		Weight::from_parts(603_028_000, 0)
	...
	fn ready() -> Weight {
		...
		Weight::from_parts(66_495_000, 0)
	...
	fn force_shard_offline() -> Weight {
		...
		Weight::from_parts(90_078_000, 0)
	...
	fn timeout_dkgs(b: u32, ) -> Weight {
		...
		// Minimum execution time: 80_419_000 picoseconds.
		Weight::from_parts(30_159_055, 0)
			.saturating_add(Weight::from_parts(0, 3654))
			// Standard Error: 356_269
			.saturating_add(Weight::from_parts(69_936_144, 0).saturating_mul(b.into()))
