...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 650_249_000 picoseconds.
		Weight::from_parts(678_402_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(67_507_000, 0)
			.saturating_add(Weight::from_parts(0, 4216))
			// Standard Error: 80_852
			.saturating_add(Weight::from_parts(51_319_311, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(27_404_048, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 171_613
			.saturating_add(Weight::from_parts(57_321_519, 0).saturating_mul(b.into()))
