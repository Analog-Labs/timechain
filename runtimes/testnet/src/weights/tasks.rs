...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1511`
		//  Estimated: `12401`
		// Minimum execution time: 656_438_000 picoseconds.
		Weight::from_parts(800_869_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		Weight::from_parts(80_140_000, 0)
			...
			// Standard Error: 249_536
			.saturating_add(Weight::from_parts(73_386_970, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(40_069_079, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 539_764
			.saturating_add(Weight::from_parts(77_440_465, 0).saturating_mul(b.into()))
