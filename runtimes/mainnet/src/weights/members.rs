...
impl<T: frame_system::Config> pallet_members::WeightInfo for WeightInfo<T> {
	...
	fn register_member() -> Weight {
		...
		Weight::from_parts(97_202_000, 0)
	...
	fn unregister_member() -> Weight {
		...
		Weight::from_parts(60_073_000, 0)
	...
	fn timeout_heartbeats(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `270 + b * (124 ±0)`
		//  Estimated: `3742 + b * (2598 ±0)`
		// Minimum execution time: 31_600_000 picoseconds.
		Weight::from_parts(22_044_162, 0)
			.saturating_add(Weight::from_parts(0, 3742))
			// Standard Error: 84_484
			.saturating_add(Weight::from_parts(21_291_693, 0).saturating_mul(b.into()))
