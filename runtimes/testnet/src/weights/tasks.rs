...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1544`
		//  Estimated: `12434`
		// Minimum execution time: 657_179_000 picoseconds.
		Weight::from_parts(720_908_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 73_307_000 picoseconds.
		Weight::from_parts(76_433_000, 0)
			.saturating_add(Weight::from_parts(0, 4176))
			// Standard Error: 243_694
			.saturating_add(Weight::from_parts(64_161_725, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(26_664_531, 0)
			.saturating_add(Weight::from_parts(0, 3894))
			// Standard Error: 105_057
			.saturating_add(Weight::from_parts(55_802_672, 0).saturating_mul(b.into()))
