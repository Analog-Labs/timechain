...
impl<T: frame_system::Config> pallet_ocw::WeightInfo for WeightInfo<T> {
	...
	fn submit_tss_public_key() -> Weight {
		...
		//  Measured:  `324`
		//  Estimated: `3789`
		// Minimum execution time: 97_822_000 picoseconds.
		Weight::from_parts(101_468_000, 0)
	...
	/// Storage: `Ocw::ShardCollector` (r:1 w:0)
	/// Proof: `Ocw::ShardCollector` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Tasks::TaskCycleState` (r:1 w:1)
	/// Proof: `Tasks::TaskCycleState` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	/// Storage: `Tasks::TaskRetryCounter` (r:0 w:1)
	/// Proof: `Tasks::TaskRetryCounter` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn submit_task_result() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `131`
		//  Estimated: `3596`
		// Minimum execution time: 89_356_000 picoseconds.
