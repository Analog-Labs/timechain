...
impl<T: frame_system::Config> bridge_multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_create_store(s: u32, z: u32, ) -> Weight {
		...
		Weight::from_parts(13_041_421, 0)
			.saturating_add(Weight::from_parts(0, 3538))
			// Standard Error: 365
			.saturating_add(Weight::from_parts(20_561, 0).saturating_mul(s.into()))
			// Standard Error: 3
			.saturating_add(Weight::from_parts(973, 0).saturating_mul(z.into()))
