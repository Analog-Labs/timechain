...
impl<T: frame_system::Config> pallet_tasks::WeightInfo for WeightInfo<T> {
	...
	fn submit_task_result() -> Weight {
		...
		//  Measured:  `1380`
		//  Estimated: `12270`
		// Minimum execution time: 653_392_000 picoseconds.
		Weight::from_parts(680_543_000, 0)
	...
	fn schedule_tasks(b: u32, ) -> Weight {
		...
		// Minimum execution time: 62_067_000 picoseconds.
		Weight::from_parts(5_317_421, 0)
			.saturating_add(Weight::from_parts(0, 7370))
			// Standard Error: 19_805
			.saturating_add(Weight::from_parts(11_326_063, 0).saturating_mul(b.into()))
	...
	fn prepare_batches(b: u32, ) -> Weight {
		...
		Weight::from_parts(44_372_064, 0)
			.saturating_add(Weight::from_parts(0, 6794))
			// Standard Error: 277
			.saturating_add(Weight::from_parts(12_076, 0).saturating_mul(b.into()))
